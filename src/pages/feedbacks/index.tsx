...
type ColumnType = ColumnDef<FeedbackInterface, unknown>;
...
export function FeedbackListPage(props: FeedbackListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<FeedbackInterface>>(
    () => `/feedbacks?params=${JSON.stringify(params)}`,
    fetcher,
  );
